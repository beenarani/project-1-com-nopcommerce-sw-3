...
/**
 * 1. Create class “TestSuite” Write the following Test:
...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.22 Fill the all mandatory field
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Beena");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "rani");
        sendTextToElement(By.id("BillingNewAddress_Email"), "beenar@gmail.com");
        sendTextToElement(By.id("BillingNewAddress_Company"), "BeeeNa");
        ...
        sendTextToElement(By.id("BillingNewAddress_Address2"), "Rugby,England");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "11004");
        ...
        //2.28 Fill all the details
        sendTextToElement(By.id("CardholderName"), "Beena Rani");
