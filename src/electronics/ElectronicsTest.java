...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        clickOnElement(By.id("gender-Female"));                                                                           //Click on gender
        sendTextToElement(By.id("FirstName"), "beena");                                                       //Enter first name
        sendTextToElement(By.id("LastName"), "rani");
        selectByValueFromDropDown(By.name("DateOfBirthMonth"), "2");
        selectByValueFromDropDown(By.name("DateOfBirthYear"), "1993");
        sendTextToElement(By.id("Password"), "beena123");                                                   //Enter password
        sendTextToElement(By.id("ConfirmPassword"), "beena123");                                            //Confirm password
        ...
        Thread.sleep(2000);
        sendTextToElement(By.id("CardholderName"), "Beena");
        sendTextToElement(By.id("CardNumber"), "5235468798456546");
